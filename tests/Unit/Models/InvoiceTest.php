...
final class InvoiceTest extends TestCase
{
    ...
    public function subtotal(): void
    {
        ...
        $item->title = 'Item';
        $item->quantity = 2;
        $item->unitPrice = 121.00; // 100 + 21% tax
        $item->taxPercentage = 21;
        $invoice->items([$item]);
    ...
    public function tax_amount(): void
    {
        ...
        $item1->title = 'Item 1';
        $item1->quantity = 1;
        $item1->unitPrice = 121.00; // 100 + 21% tax
        $item1->taxPercentage = 21;

        $item2 = InvoiceItem::make();
        $item2->title = 'Item 2';
        $item2->quantity = 1;
        $item2->unitPrice = 110.00; // 100 + 10% tax
        $item2->taxPercentage = 10;
    ...
    public function tax_groups(): void
    {
        ...
        $item2->taxPercentage = 9;

        $item3 = InvoiceItem::make();
        $item3->title = 'Item 3';
        $item3->quantity = 1;
        $item3->unitPrice = 10.00;
        $item3->taxPercentage = 21;

        $item4 = InvoiceItem::make();
        $item4->title = 'Item 4';
        $item4->quantity = 1;
        $item4->unitPrice = 10.00;
        $item4->taxPercentage = null;
    ...
    public function tax_amount_for_group(float $taxPercentage, float $expected): void
    {
        ...
        $item1->title = 'Item 1';
        $item1->quantity = 1;
        $item1->unitPrice = 121.00;
        $item1->taxPercentage = 21;

        $item2 = InvoiceItem::make();
        $item2->title = 'Item 2';
        $item2->quantity = 1;
        $item2->unitPrice = 110.00;
        $item2->taxPercentage = 10;
