 ...
 */
final class UsageReceiptItem implements UsageReceiptItemInterface
{
    ...
    public function validate(?int $index = null): void
    {
        ...
        if ($this->price < 0) {
            throw new InvalidUsageReceiptItemException("{$prefix} price cannot be negative");
        }
    }
